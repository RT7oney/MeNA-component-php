...
class MySendMail {
	...
	protected function sendCommand($command, $code) {
		mail_common_log('Send command:' . $command . ',expected code:' . $code);
...
function mail_common_log($log_data) {
	$fd = fopen('./log/' . date('Ym') . 'email.log', "a");
